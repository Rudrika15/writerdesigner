...
@section('title', 'Brand beans | Update Template')
@section('content')
    <div class='container'>
        <div class='row'>
            <div class='col-md-12'>
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div class="p-2">
                        <a href="{{ route('userTemplate.index') }}" class="btn btn-primary btn-sm">Back</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('userTemplate.update') }}" enctype="multipart/form-data" method="post" style="margin-top: 15px;">
                            @csrf
