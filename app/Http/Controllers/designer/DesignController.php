...
class DesignController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            $writers = Writerslogan::with('category')
            ...
            return view('designer.design.index', \compact('writers', 'slugCount'));
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function create($slugId, $category)
    {
        // return $category;
        try {
            return view('designer.design.create', \compact('slugId', 'category'));
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('designer.show')->with('success', 'Design Created Successfully');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('designer.design.edit', \compact('design'));
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('designer.show')->with('success', 'Design Update Successfully');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function destroy($id)
    {
        try {
            $design = Design::find($id);
            $design->delete();
            return redirect()->back()->with('error', 'Design Deleted Successfully');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
